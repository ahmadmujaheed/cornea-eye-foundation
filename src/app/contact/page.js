      ...
      <main className="bg-white min-h-screen">
        ...
        <section className="relative h-[60vh] w-full flex items-center justify-center">
          ...
          <motion.h1
            ...
            animate={{ opacity: 1, y: 0 }}
            className="relative text-5xl font-black text-white uppercase"
          >
            Contact Us
          </motion.h1>
        </section>
        ...
        <section className="max-w-7xl mx-auto px-6 py-24">
          ...
          <div className="grid md:grid-cols-3 gap-12 mb-16">
            <div>
              <p className="text-xs font-bold uppercase mb-2">Address:</p>
              <p className="text-gray-600 text-sm">
                NAF Base, Kaduna, Nigeria
              </p>
            </div>
            <div>
              <p className="text-xs font-bold uppercase mb-2">Email:</p>
              <p className="text-[#C99B3B] text-sm">
                nigeriacorneafoundation@gmail.com
              </p>
            </div>
            <div>
              <p className="text-xs font-bold uppercase mb-2">Phone:</p>
              <p className="text-[#C99B3B] text-sm">
                +234 812 953 1011
              </p>
            </div>
          ...
          <Form form={form} layout="vertical">
            ...
            <button
              type="submit"
              className="bg-[#C99B3B] px-8 py-3 text-white font-bold"
            >
              Send Message
            </button>
          </Form>
